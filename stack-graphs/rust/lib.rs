...
pub const STACK_GRAPHS_BUILTINS_PATH: &str = "src/builtins.sol";
/// The stack graphs builtins source for this language.
pub const STACK_GRAPHS_BUILTINS_SOURCE: &str = include_str!("../src/builtins.sol");
